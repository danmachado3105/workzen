...
export function ServicesPage() {
  ...
  return (
    <div className="page">
      ...
      {error && <div className="dashboard-status dashboard-status-error" role="alert"><span>{error}</span><Button variant="secondary" onClick={loadServices}>Tentar novamente</Button></div>}
